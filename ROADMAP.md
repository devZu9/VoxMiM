...
## Фаза 11a: Wake Word + VAD Integration 🟢
...
| **VAD** | +4 | VAD-режим: автостоп по тишине | 🟢 **v0.7.0** |
...
| **WakeWord** | +11 | Триггер-фраза вместо горячей клавиши | 🟢 **v0.7.0** |
| **Wake+VAD** | +11a | Wake + VAD без конфликтов | 🟢 |
