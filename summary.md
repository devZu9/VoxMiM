...
> **v0.7.2:** Найден корень проблемы разорванных слов — whisper server рендерит текст фиксированной шириной и вставляет `\n` в середине слов. `\n` удаляется из ответа сервера, эвристики `space_fixer` стали избыточны.
