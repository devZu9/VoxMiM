...
- **voxmim**: 0.9.0 (VAD: aggressiveness → threshold f32, синхронизация трея, фикс миграции)
- **voxmim-settings**: 1.3.0 (чувствительность микрофона со спин-кнопками, polling config.json)
