...
- **voxmim**: 0.8.0 (расширение: галлюцинации, настройки, детекция через сервер)
- **voxmim-settings**: 1.1.0 (расширение: спин-кнопки, icon_button, radio buttons)
