# VoxMiM v0.7.5 — Итоговая сводка

## Что сделано

**VoxMiM** — голосовой ввод текста на Rust. По мотивам VoxBee с исправлением ключевой ошибки (разорванные слова).

> **v0.7.5:** Удалён мёртвый код Slint (`settings.rs`, `settings.slint`, зависимости `slint`/`slint-build`). Debug-сборка voxmim.exe уменьшилась с ~35 МБ до ~11 МБ.
>
...
- [x] **Версионность окна настроек** — v1.0.4, показывает `env!("CARGO_PKG_VERSION")` в заголовке
