# VoxMiM v0.9.3 — Итоговая сводка

## Что сделано

**VoxMiM** — голосовой ввод текста на Rust. По мотивам VoxBee с исправлением ключевой ошибки (разорванные слова).

> **v0.9.3:** Дефолтный таймаут 120→60 сек. На ретраях — 30 сек. State = Idle сразу после первой ошибки, хоткей не блокируется. Ретраи в фоне.
>
...
- **voxmim**: 0.9.3 (state = Idle сразу, дефолт 60s, ретраи 30s)
