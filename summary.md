...
- **voxmim**: 0.8.1 (исправления: позиция окна, tab save, чистка мёртвого кода)
- **voxmim-settings**: 1.2.0 (расширение: позиция окна, сохранение вкладки, полировка UI)
...
- [x] **Сохранение позиции окна настроек** — v0.8.1, каждое apply() обновляет window_x/y
