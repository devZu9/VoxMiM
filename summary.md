# VoxMiM v0.9.4 — Итоговая сводка

## Что сделано

**VoxMiM** — голосовой ввод текста на Rust. По мотивам VoxBee с исправлением ключевой ошибки (разорванные слова).

> **v0.9.4:** Pending WAV — фраза не теряется при ошибке сервера. Индикатор перезапуска в трее (hourglass). Ретрай удалён — одна попытка, pending на диск.
>
...
- **voxmim**: 0.9.4 (pending.wav + индикатор перезапуска)
